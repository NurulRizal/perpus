                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-notes_2"></i><?php echo "Master Divisi";?><br><br>
                    ...
                    <ul class="breadcrumb breadcrumb-top">
                        <li>Forms</li>
                        <li><a href="">Tambah Master Divisi</a></li>
                    </ul>
                            ...
                            <div class="block">
                                ...
                                <form  action="" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="example-text-input" name="subject" class="form-control" placeholder="Nama Divisi">
                                        </div>
                                    </div>
