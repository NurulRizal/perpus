                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-book"></i><?php echo "Tambah Berita"?><br><br>
                            ...
                            <div class="block">
                                ...
                                <form  action="" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="example-text-input" name="judul" class="form-control" placeholder="Judul Berita" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-textarea-input">Body</label>
                                        <div class="col-md-9">
                                            <textarea id="example-textarea-input" name="body" rows="9" class="form-control" placeholder="Content.."></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
