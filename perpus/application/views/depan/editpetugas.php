                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-user"></i><?php echo "Edit Data Pustakawan"?><br><br>
                    ...
                    <ul class="breadcrumb breadcrumb-top">
                        <li>Forms</li>
                        <li><a href="">Edit Data Pustakawan</a></li>
                    </ul>
                                ...
                                <form  action="" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="text" id="example-text-input" name="staff" class="form-control" placeholder="Kode Pusatakawan" value="<?php echo $petugas['kode_staff'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">Username</label>
                                        <div class="col-md-9">
                                            <input type="text" id="example-text-input" name="user" class="form-control" placeholder="Username" value="<?php echo $petugas['user'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="email" id="example-text-input" name="email" class="form-control" placeholder="Email" value="<?php echo $petugas['email'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">No Telp</label>
                                        <div class="col-md-9">
                                            <input type="text" id="example-text-input" name="tlp" class="form-control" placeholder="No Telp" value="<?php echo $petugas['tlp'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select id="example-select" name="role" class="form-control" size="1">
                                                <option value="<?php echo $petugas['role'];?>"><?php echo $petugas['role'];?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <img src="<?php echo base_url('assets/img/'.$petugas['gambar']);?>" height="200px" width="200px">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">Gambar</label>
